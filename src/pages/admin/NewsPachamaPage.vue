...
import {
  ...
  useEditNewMutation,
  useDeletePachamaNewMutation,
} from 'src/querys/pachamaNewsQuerys';
...
const { mutate: createNewInformative, isLoading: isLoadingCreate } =
  useCreateNewMutation();
const { mutate: deleteNewInformative } = useDeletePachamaNewMutation();
          ...
          <template v-slot:body="props">
            <q-tr :props="props">
              ...
              <q-td key="descripcion" :props="props">
                <p v-html="props.row?.descripcion" />
              </q-td>
