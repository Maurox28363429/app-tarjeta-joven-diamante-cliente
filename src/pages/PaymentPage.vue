      ...
      <div class="payment">
        <div>
          <div class="row items-center q-py-md">
            <router-link to="/memberships" style="text-decoration: none">
              <q-icon
                name="arrow_back"
                size="xl"
                color="primary"
        ...
        <div class="full-width justify-center paymentGrid">
          ...
          <section class="">
            <div class="detailPayment q-gutter-y-lg">
              ...
              >
                <div class="row items-center">
                  <p class="q-ma-none text-primary q-mr-md">Plan pro</p>
                  <q-img
              ...
              <p class="text-h6">¿Qué estás adquiriendo con el plan pro?</p>
